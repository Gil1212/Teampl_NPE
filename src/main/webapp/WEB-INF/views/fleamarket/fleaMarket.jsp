            ...
            "success": function(rData) {
                ...
                for (var i = 0; i < rData.length; i++) {
                    ...
                    var row = "<tr>" +
                              ...
                              "<td><a class='a_title' href='/fleamarket/reading?mbno=" + marketboardVo.mbno + "'>" + marketboardVo.mbtitle + "</a></td>" +
         ...
         <div class="col-md-10">
            ...
            <div class="MarketBoardDiv">
               <div class="background-image-container">
                ...
                <div class="container-fluid text-center mt-5 pt-5" style="height: 40vh;">
                <h1 style="font-family: 'Orbit', sans-serif;" class="display-1"> 플리마켓 </h1>
             </div>
          </div>
               ...
               <div class="container-fluid">
                        ...
                        <div class="row">
                                          ...
                                          <tr>
                                             ...
                                             <c:choose>
                                                <c:when  test="${not empty marketboardVo.solddate }">
                                                   <td><a class="a_title" href="/fleamarket/reading?mbno=${marketboardVo.mbno}" style="text-decoration-line: none;">${marketboardVo.mbtitle}(판매완료)</a></td>
                                                </c:when>
                                                <c:otherwise>
                                                      <td><a class="a_title" href="/fleamarket/reading?mbno=${marketboardVo.mbno}" style="text-decoration-line: none;">${marketboardVo.mbtitle}</a></td>
                                                </c:otherwise>
                                             </c:choose>
                                             <td>${marketboardVo.readcount}</td>
                                          </tr>
                           ...
                           <div class="col-md-6">
                              <div class="row">
                                 <div class="col-md-6">
                                    <div class="card">
                                       <img class="card-img-top" src="/images/bean.png" />
                ...
                <a class="btn btn-primary" href="/fleamarket/writing">
                        글쓰기
                </a>
                  <!-- 플리마켓 상세 검색 searchDiv 시작 -->
               <div class="container-fluid">
                        ...
                        <div id="divSearch" class="jumbotron">
                           ...
                           <div id="divCheckbox" class="btn-group" role="group" 
                              ...
                              <input type="checkbox" class="btn-check" id="btncheck1"
                                 autocomplete="off" value="B" name="categories">
                              <label class="btn btn-outline-primary" for="btncheck1">원두</label> 
                              
                              <input type="checkbox" class="btn-check" id="btncheck2"
                                 autocomplete="off" name="categories" value="G"> 
                              <label class="btn btn-outline-primary" for="btncheck2">글라인더</label>
                               
                              <input type="checkbox" class="btn-check" id="btncheck3"
                                 autocomplete="off" name="categories" value="S"> 
                              <label class="btn btn-outline-primary" for="btncheck3">시럽</label>
                              
                              <input type="checkbox" class="btn-check" id="btncheck4"
                                 autocomplete="off" name="categories" value="E"> 
                              <label class="btn btn-outline-primary" for="btncheck4">기타</label>
                           ...
                           <div id="searchInputDiv">
                              <form class="d-flex" role="search">
                                 <input id="inputSearch" class="form-control me-2" type="search"
                                    placeholder="검색어를 입력하세요" aria-label="Search" name="keyword">
         
                                 <button class="btn btn-outline-success" type="submit" id="btnCategories">검색</button>
                              </form>
                           </div>
               ...
               <div class="row">
                  ...
                  <div class="col-md-8" id="writing">
                     <a class="btn btn-primary"
                        href="/fleamarket/writing">
                        글쓰기
                     </a>
                     <button id="scrollToTopBtn" class="btn btn-primary">최상단으로 이동</button>
                  </div>
